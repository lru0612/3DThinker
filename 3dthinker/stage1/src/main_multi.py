...
from utils import *
from task import *
from trainer_multi import CustomTrainerStage1, CustomTrainerStage2
...
def setup_wandb(args, rank):
    ...
    if rank == 0:
        wandb.init(
            project="3dthinker-training",  # project name
...
processor.image_processor.max_pixels = 1024 * 1024  # pixel uperbound
...
def collate_fn_stage1(examples):
    ## replace <output_image> -> <|latent_start|><|image_pad|><|latent_end|>
    idx_list = []
    ...
    ## xxx xxx 151655 15165 15165 ... 151665 151665 151665.... image token
