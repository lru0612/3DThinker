...
def load_model(model_path):
    ...
    try:
        ...
        print("Qwen3-VL model and processor loaded successfully!")
    ...
    for sample in tqdm(samples, desc="Processing samples"):
        try:
            ...
            try:
                ...
                # Preparation for inference (Qwen3-VL)
...
def main():
    ...
    # model_path = "models/Qwen/Qwen3-VL-2B-Instruct/main"
    # model_path = "models/Qwen/Qwen3-VL-4B-Instruct/main"
    # model_path = "models/Qwen/Qwen3-VL-4B-Instruct/main"
    # model_path = "models/Qwen/Qwen3-VL-8B-Instruct/main"
    model_path = "models/Qwen/Qwen3-VL-30B-A3B-Instruct/main"
